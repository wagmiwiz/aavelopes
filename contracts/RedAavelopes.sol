...
contract RedAavelopes is ERC721 {
    ...
    function balance(uint256 _tokenId) public view virtual returns (uint256) {
        return _balances[_tokenId];
    }

    function depositTimestamp(uint256 _tokenId) public view virtual returns (uint256) {
        return _depositTimestamps[_tokenId];
    }

    function unlockTimestamp(uint256 _tokenId) public view virtual returns (uint256) {
